...
- shortcode จะดึงค่าล่าสุดจาก `GET /wp-json/bizgital/v1/gold-price-latest` อัตโนมัติทุกช่วงเวลา
...
ถ้า `200 OK` แล้วค่าบน shortcode ควรอัปเดตเองภายในไม่กี่วินาที (ไม่ต้องรีเฟรชหน้า)
...
6. อัปเดตแล้วค่าในเว็บยังไม่เปลี่ยน:
- ปลั๊กอินจะพยายาม purge cache อัตโนมัติแล้ว
- ถ้ายังค้าง ให้ purge CDN/edge cache (เช่น Cloudflare) เพิ่มอีกครั้ง
